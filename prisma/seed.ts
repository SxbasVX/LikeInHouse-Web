    ...
    data: [
      {
        ...
        country: "Argentina",
        tourName: "Cusco Magico 4D/3N",
        rating: 5,
        textEs: "Increible experiencia! El guia fue muy profesional y conocedor. Machu Picchu supero todas mis expectativas. La organizacion del tour fue impecable, desde el recojo en el aeropuerto hasta la despedida. Totalmente recomendado.",
        textEn: "Incredible experience! The guide was very professional and knowledgeable. Machu Picchu exceeded all my expectations. The tour organization was flawless, from airport pickup to farewell. Totally recommended.",
        isApproved: true,
        isFeatured: true,
      },
      {
        ...
        tourName: "Cusco Magico 4D/3N",
        rating: 5,
        textEs: "Un viaje que cambia la vida. La atencion personalizada y los detalles del tour hicieron toda la diferencia. El Valle Sagrado es impresionante y el equipo se aseguro de que estuvieramos comodos en todo momento.",
        textEn: "A life-changing trip. The personalized attention and tour details made all the difference. The Sacred Valley is breathtaking and the team made sure we were comfortable at all times.",
        isApproved: true,
        isFeatured: true,
      },
      {
        ...
        tourName: "Cusco Magico 4D/3N",
        rating: 4,
        textEs: "Muy buen tour, especialmente la visita a Machu Picchu. El hotel era comodo y la comida deliciosa. Lo unico que mejoraria es dar mas tiempo libre en Aguas Calientes. Sin duda volveria a viajar con ustedes.",
        textEn: "Very good tour, especially the Machu Picchu visit. The hotel was comfortable and the food delicious. The only thing I'd improve is giving more free time in Aguas Calientes. I would definitely travel with you again.",
        isApproved: true,
        isFeatured: false,
      },
    ],
